...
export const User = ( {id, email, first_name, last_name, avatar, isInvited, handleChangeInvites } ) => (
  <li>
    <div>
    ...
    <img onClick={() => handleChangeInvites(id)} className="action" src={`./assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" />
  </li>
);
